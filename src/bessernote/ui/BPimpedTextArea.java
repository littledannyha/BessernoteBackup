...
import org.fxmisc.richtext.demo.RichText;
 ...
 * @author Dan
 */
public class BPimpedTextArea extends Pane {
...
//        panel.getChildren().add(p);
    ...
    private Button createButton(String styleClass, Runnable action) {
        Button button = new Button(styleClass);
        button.setText(styleClass);
